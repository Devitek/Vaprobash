...
if [[ $2 == "true" ]]; then
    ...
    echo deb http://packages.dotdeb.org wheezy-php55 all | sudo tee /etc/apt/sources.list.d/dotdeb.list
    echo deb-src http://packages.dotdeb.org wheezy-php55 all | sudo tee /etc/apt/sources.list.d/dotdeb.list
